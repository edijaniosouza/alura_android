...
public class FormularioAlunoActivity extends AppCompatActivity {
    ...
    private void preencheCamposDeTelefone() {
        new BuscaTodosTelefonesTask(telefoneDAO, aluno.getId(), telefones -> {
    ...
    private Telefone criaTelefone(EditText campoTelefoneFixo, TipoTelefone fixo) {
        return new Telefone(campoTelefoneFixo.getText().toString(), fixo);
    }

    private void salvaAluno(Telefone numeroFixo, Telefone numeroCelular) {
        new SalvaAlunoTask(alunoDAO, aluno, telefoneDAO, numeroFixo, numeroCelular, this::finish).execute();
    }

    private void editaAluno(Telefone numeroFixo, Telefone numeroCelular) {

        new EditaAlunoTask(alunoDAO, telefoneDAO, aluno, numeroFixo, numeroCelular, telefonesAluno, this::finish).execute();
    }
