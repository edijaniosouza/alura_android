...
public class BuscaPrimeiroAlunoTask extends AsyncTask<Void,Void, Telefone> {
    private final TelefoneDAO dao;
    private final int alunoId;
    private final PrimeiroTelefoneEncontradoListener listener;

    public BuscaPrimeiroAlunoTask(TelefoneDAO dao, int alunoId, PrimeiroTelefoneEncontradoListener listener) {
        this.dao = dao;
    ...
    protected void onPostExecute(Telefone primeiroTelefone) {
       ...
       // campoTelefone.setText(primeiroTelefone.numero);
    }
